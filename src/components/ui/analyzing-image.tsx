...
export function AnalyzingImage({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div role="status" aria-label="Gerando imagem" className={cn("relative isolate shrink-0", className)} {...props}>
      <motion.div
        initial={{ clipPath: "inset(0% 0% 0% 0%)" }}
        animate={{ clipPath: ["inset(0% 0% 0% 0%)", "inset(0% 105% 0% 0%)", "inset(0% 105% 0% 0%)", "inset(0% 0% 0% 0%)"] }}
        transition={transition}
        className="absolute inset-0 z-10 bg-[var(--areia)]"
      >
      ...
      <motion.div
        ...
        animate={{ transform: ["translateX(1400%)", "translateX(-80%)", "translateX(-80%)", "translateX(1400%)"] }}
        transition={transition}
        className="absolute z-10 h-full w-[7%] rounded-full bg-current"
      />
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 size-full">
        <path
          d="M6.8 21H17.2C18.8802 21 19.7202 21 20.362 20.673C20.9265 20.3854 21.3854 19.9265 21.673 19.362C22 18.7202 22 17.8802 22 16.2V7.8C22 6.11984 22 5.27976 21.673 4.63803C21.3854 4.07354 20.9265 3.6146 20.362 3.32698C19.7202 3 18.8802 3 17.2 3H6.8C5.11984 3 4.27976 3 3.63803 3.32698C3.07354 3.6146 2.6146 4.07354 2.32698 4.63803C2 5.27976 2 6.11984 2 7.8V16.2C2 17.8802 2 18.7202 2.32698 19.362C2.6146 19.9265 3.07354 20.3854 3.63803 20.673C4.27976 21 5.11984 21 6.8 21Z"
          stroke="currentColor"
          strokeWidth="1.5"
